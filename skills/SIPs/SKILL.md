...
**錯殺反彈進場規則(2026-08-07 一個月 ex-ante 回測定調):** 開盤直接進場=負期望(7/7–8/5 47 筆 avgR −0.22,停損加寬到 6% 也救不回);一律「**10:30 ET 前不進場**、第一小時低點不破才進」(同樣本 10:30 進場 avgR +0.13、市值 ≥10B +0.23/勝率 59%,六格敏感度全同向;6 月非財報季僅 2 筆無法 OOS → 標樣本累積中)。市值 ≥10B 優先。DTC>5 軋空維持開盤進 3R 目標(6+7 月 55 筆 avg +0.52R,月間 regime 波動大是常態)。
