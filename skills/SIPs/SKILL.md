...
**雙29% OPG 降權(2026-08-07):** 7 月樣本 −0.27R(n=42)失效 — 先前 +0.30R 來自更長窗口;列「樣本重驗中」,單獨出現不構成 idea,只做加分因子。組合月績效參考:v2(含以上全部規則)7 月 63 筆、51% 勝、+0.30R/筆、+18.8R/月。**以上全部由 7 月樣本調出 — 8 月起的 live ex-ante 對帳才算真驗證,別把 +18.8R 當保證。**
