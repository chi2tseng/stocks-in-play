...
HCA CI MCK COR
# 2026-09-24 追加:AI 電力/資料中心供電與電氣化族群(原宇宙只有 GEV,BE -6.3% 與當日 #1 精選 P 都漏掉)
BE CEG VST NRG TLN OKLO SMR VRT ETN PWR NEE EMR PH ROK FSLR CARR JCI EME AOS
# 2026-09-24 追加:其餘遺漏的標普 500 成分/知名大型股
