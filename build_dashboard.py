...
/* Catalyst-type palette — saturated solid-color tints for fast identification.
   Each preset has its own hue + matching darker text. Borders match the bg hue at 0.5α so
   the pills feel solid in light mode and still legible in dark mode (text auto-lightens). */
.cat-type-earnings      { background: rgba(73, 79, 223, 0.22);  color: var(--primary);            border-color: rgba(73, 79, 223, 0.50); }
.cat-type-momentum      { background: rgba(255, 178, 30, 0.24); color: #8a5800;                   border-color: rgba(255, 178, 30, 0.55); }
.cat-type-fda           { background: rgba(0, 168, 126, 0.22);  color: var(--pos);                border-color: rgba(0, 168, 126, 0.50); }
.cat-type-ma            { background: rgba(226, 59, 74, 0.22);  color: var(--neg);                border-color: rgba(226, 59, 74, 0.50); }
.cat-type-contract      { background: rgba(94, 158, 214, 0.24); color: #1e5d8e;                   border-color: rgba(94, 158, 214, 0.55); }
.cat-type-technical     { background: rgba(160, 100, 220, 0.22);color: #5928a3;                   border-color: rgba(160, 100, 220, 0.55); }
.cat-type-fbo           { background: rgba(255, 105, 100, 0.22);color: #b53b3b;                   border-color: rgba(255, 105, 100, 0.55); }
.cat-type-short-squeeze { background: rgba(255, 140, 0, 0.24);  color: #8a4500;                   border-color: rgba(255, 140, 0, 0.55); }
body.dark .cat-type-earnings      { color: #a5a9ff; }
body.dark .cat-type-momentum,
body.dark .cat-type-short-squeeze { color: #ffce6a; }
body.dark .cat-type-fda           { color: #56e4b3; }
body.dark .cat-type-ma,
body.dark .cat-type-fbo           { color: #ff9a96; }
body.dark .cat-type-contract      { color: #6dc0ff; }
body.dark .cat-type-technical     { color: #c7a4ff; }
