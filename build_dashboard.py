  ...
  app.innerHTML = `
    ...
    <div class="stock-header" style="position:relative">
      ...
      <div style="margin-left:auto;text-align:right">
        ...
        <div class="chg ${cls(chg)}" id="study-chg-readout" title="${chgSource}">${fmtPct(chg)} · Vol <span class="vol-editable" id="study-vol-cell" title="Click to edit volume (linked to OHLCV)"><span class="vol-text">${fmtVol(displayVol)}</span></span></div>
      </div>
    </div>
