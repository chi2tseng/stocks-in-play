...
/* Catalyst-type palette — matches the SIP page's .tag-earnings design system: solid pastel
   tint background (~0.14 alpha) + bold deep-tone text. Each preset has its own hue. The
   text colour is intentionally darker than the bg so it pops without needing a border. */
.cat-type-earnings      { background: rgba(73, 79, 223, 0.14);  color: var(--primary-deep); }
.cat-type-momentum      { background: rgba(255, 178, 30, 0.18); color: #8a5800; }
.cat-type-fda           { background: rgba(0, 168, 126, 0.16);  color: #008060; }
.cat-type-ma            { background: rgba(226, 59, 74, 0.14);  color: #b03040; }
.cat-type-contract      { background: rgba(94, 158, 214, 0.18); color: #1e5d8e; }
.cat-type-technical     { background: rgba(160, 100, 220, 0.16);color: #5928a3; }
.cat-type-fbo           { background: rgba(255, 105, 100, 0.16);color: #b53b3b; }
.cat-type-short-squeeze { background: rgba(255, 140, 0, 0.18);  color: #8a4500; }
