...
/* Latest-reported column — both the small grey date AND the data numbers below
   share the same flush-left alignment so they sit visually in a single column.
   Other columns stay right-aligned per financial-table convention. */
.ms-table td.ms-col-latest { text-align: left; }
  ...
  app.innerHTML = `
    ...
    ${sectionCard('ms_table', `<h3>季度 EPS / Sales <span class="label-en">Reported + Estimate · click any value to edit</span></h3>`,
      `<div class="quarter-switcher-row">
         ...
         <span class="qs-hint">drives bar charts, MS-table window, Forward YoY · auto-syncs with OHLCV date</span>
       </div>
